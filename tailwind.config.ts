  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "section-light": {
          bg: "hsl(var(--section-light-bg))",
          fg: "hsl(var(--section-light-fg))",
          muted: "hsl(var(--section-light-muted))",
          border: "hsl(var(--section-light-border))",
        },
        whatsapp: {
      ...
      backgroundImage: {
        'gradient-metallic': 'linear-gradient(135deg, hsl(0, 0%, 65%), hsl(0, 0%, 85%), hsl(0, 0%, 70%))',
